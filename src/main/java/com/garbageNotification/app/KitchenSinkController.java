...
import com.garbageNotification.service.textMessageService;
...
public class KitchenSinkController {
        ...
        handleHeavyContent(
                ...
                responseBody -> {
                    ...
                    if (provider.isExternal()) {
                        //jpg = new DownloadedContent();
                    	//previewImg = new DownloadedContent();
                    } else {
    ...
    private void handleTextContent(String replyToken, Event event, TextMessageContent content)
        ...
        case "いいえ": {
            this.reply(replyToken,
                        Arrays.asList(
                                new StickerMessage("1", "123"),
                                new TextMessage("はよ捨てにいきなはれや！"))
            );
            break;
        }
        default:
